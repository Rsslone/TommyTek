...
recipes.addShaped(<powersuits:powerarmorcomponent:12>, [[<draconicevolution:draconic_core>, <avaritia:resource:4>, <draconicevolution:draconic_core>], [<avaritia:resource:4>, <draconicevolution:draconium_block>, <avaritia:resource:4>], [<draconicevolution:draconic_core>, <avaritia:resource:4>, <draconicevolution:draconic_core>]]);
...
recipes.addShaped(<powersuits:power_fist>, [[null, <immersiveengineering:metal:33>, null], [<immersiveengineering:metal:33>, <avaritia:block_resource:2>, <immersiveengineering:material:21>], [null, <immersiveengineering:metal:33>, <immersiveengineering:metal:33>]]);
recipes.addShaped(<powersuits:powerarmor_feet>, [[<immersiveengineering:material:21>, null, <immersiveengineering:material:21>], [<avaritia:resource>, null, <avaritia:resource>], [<immersiveengineering:metal:33>, null, <immersiveengineering:metal:33>]]);
