...
ResearchTable.builder("compMaster", compCat)
  ...
  .addCondition(<liquid:creosote> * 50)
  .addCondition(<ore:electronTube> * 300)
  .setRequiredResearches("electMaster")
  .setOptionalStages(2, "shieldenergy", "solarenergy", "petrolenergy")
  .setOptionalStages(2, "improvedBackpacks2", "ironchest2", "hooked3", "danknull2")
