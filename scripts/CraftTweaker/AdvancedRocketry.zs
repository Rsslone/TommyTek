...
recipes.addShaped(<advancedrocketry:rocketmotor>, [[<ore:ingotSteel>, <ore:ingotSteel>, <ore:ingotSteel>], [null, <ore:plateTitanium>, <mekanism:machineblock:12>], [<libvulpes:productplate:7>, null, <libvulpes:productplate:7>]]);
